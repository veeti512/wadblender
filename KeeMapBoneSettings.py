...
class KeeMapBoneMappingListItem(bpy.types.PropertyGroup): 
    ...
    swap_yz: bpy.props.BoolProperty(
        name = "Swap Y/Z Location Axis",
        description = "Swap vertical and forward motion",
        default = False
    )

    swap_xz: bpy.props.BoolProperty(
        name = "Swap Y/Z Location Axis",
        description = "Swap vertical and forward motion",
        default = False
    )

    swap_xy: bpy.props.BoolProperty(
        name = "Swap X/Y Location Axis",
        description = "",
        default = False
    )
    ...
    invert_x_rot: bpy.props.BoolProperty(
        name = "Invert x rotation",
        description = "Swap vertical and forward motion",
        default = False
    )

    invert_y_rot: bpy.props.BoolProperty(
        name = "Invert y rotation",
        description = "",
        default = False
    )

    invert_z_rot: bpy.props.BoolProperty(
        name = "Invert z rotation",
        description = "",
        default = False
    )

    position_gain_vec: bpy.props.FloatVectorProperty(
        name = 'Position gain',
        description = 'x y z get multiplied by this value',
        subtype = 'XYZ',
        size = 3,
        default = (1.0,1.0,1.0)
    )
